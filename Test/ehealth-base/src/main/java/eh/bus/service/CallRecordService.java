...
public class CallRecordService {
    ...
    public static final Logger logger = Logger.getLogger(CallRecordService.class);
    ...
    public void handlerCallRecord() {
        logger.info("this is handlerCallRecord============start");
    ...
    public QueryResult<CallRecord> queryResultForOP(Date bDate, Date eDate, Integer bussType, Integer bussId
            , String fromMobile, String toMobile, Integer callTime, int start, int limit) {

        CallRecordDAO callRecordDAO = DAOFactory.getDAO(CallRecordDAO.class);
        return callRecordDAO.queryResultForOP(bDate, eDate, bussType, bussId, fromMobile, toMobile, callTime, start, limit);
    }
}
