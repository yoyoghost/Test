 ...
 * date:2016/12/19
 */
public class BussCancelEvent extends BussEvent{

    //会诊业务申请单ID
    private Integer meetClinicId;

    public BussCancelEvent(Integer bussId,Integer bussType){
        setBussId(bussId);
        setBussType(bussType);
    }

    public BussCancelEvent(Integer bussId,Integer bussType,Integer meetClinicId){
