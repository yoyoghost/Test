...
@Component
@Scope("prototype")
public class AppointpayPayCallback implements PayCallback<PayResult> {
    private static final Logger logger = LoggerFactory.getLogger(AppointpayPayCallback.class);
