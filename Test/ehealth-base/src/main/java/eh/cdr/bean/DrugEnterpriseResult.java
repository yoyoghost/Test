...
import eh.cdr.drugsenterprise.AccessDrugEnterpriseService;
...
public class DrugEnterpriseResult extends RecipeResultBean{
    ...
    public String toString() {
        return "code="+getCode()+"***msg="+getMsg()+"***accessDrugEnterpriseService="+((null!=this.accessDrugEnterpriseService)?this.accessDrugEnterpriseService.getClass().getSimpleName():"");
    }
}
